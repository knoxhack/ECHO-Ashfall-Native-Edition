# Ashfall Native Edition Update Flow

Ashfall Native Edition supports file-level and module-level updates through ECHO Launcher.

## Flow

1. Fetch the current release metadata for `knoxhack/ECHO-Ashfall-Native-Edition`.
